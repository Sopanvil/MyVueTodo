<template>
  <div class="container">
    ...
    <div class="tasks-input animated fadeInLeft col-md-4 col-xs-12">
        <input class="tasks-input-text " type="text" v-model="newTodo" placeholder="Создайте задачу">
      </div>
      <div class="tasks-input-b col-md-6 animated fadeInLeft col-xs-12">
        <input class="tasks-input-button" type="button" value="Добавить" @click="addNewTodo(newTodo, id)">
      </div>
    </div>
    <div class="row">
        <div class="">
